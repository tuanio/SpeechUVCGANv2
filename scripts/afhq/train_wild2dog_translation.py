...
def parse_cmdargs():
    parser = argparse.ArgumentParser(description="Train AFQH Wild2Dog I2I model")
...
args_dict = {
    ...
    "outdir": os.path.join(ROOT_OUTDIR, "afhq_resized_lanczos", "wild2dog"),
    "log_level": "DEBUG",
    "checkpoint": 50,
}
