...
cd preprocess_audio && python preprocess.py \
    --src-path /home/stud_vantuan/share_with_150/cache/cd92.93_95_with_5h_clean_and_5h_noisy/splitted_data/clean/train \
...
cd preprocess_audio && python preprocess.py \
    --src-path /home/stud_vantuan/share_with_150/cache/cd92.93_95_with_5h_clean_and_5h_noisy/splitted_data/noisy/test \
